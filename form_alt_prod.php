...
<head>
    ...
    <title>Stockin' Song - Alterar</title>
</head>
<body>
    ...
    <form action="alt_prod.php" method="post">
        ...
        Insira o novo nome do álbum selecionado:
        <br><input type="text" placeholder="Nome do álbum" name="c_novo_nome" size=50 maxlength=50><br>
